...
var defaultOptions = {
  ...
  cMapUrl: {
    value: 'https://cdn.hopjs.net/npm/pdfjs-dist@2.2.228/cmaps/',
    kind: OptionKind.API
  },
  disableAutoFetch: {
    value: false,
  ...
  workerSrc: {
    value: 'https://cdn.hopjs.net/npm/pdfjs-dist@2.2.228/build/pdf.worker.min.js',
    kind: OptionKind.WORKER
  }
};
{
...
if (typeof window !== 'undefined' && window['pdfjs-dist/build/pdf']) {
  ...
  pdfjsLib = require('https://cdn.hopjs.net/npm/pdfjs-dist@2.2.228/build/pdf.min.js');
}
